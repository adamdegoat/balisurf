...
export const CONDITIONS = {
  ...
  easy:    { H: 2.0,  speed: 5.6,  peel: 2.7,  angle: 62, period: 12, hollow: 0.72, forgive: 0.6, len: 1,   width: 1.3,  fat: 1.3, tube: 1.3,  name: 'Easy' },     // small, slow, friendly: a round little tube you can crouch in
  medium:  { H: 3.0,  speed: 7.2,  peel: 3.8,  angle: 62, period: 14, hollow: 0.8,  forgive: 1,   len: 1.1, width: 1.1,  fat: 1.1, tube: 1.0,  name: 'Medium' },   // clean peeling walls
  hard:    { H: 4.5,  speed: 8.9,  peel: 6.2,  angle: 55, period: 16, hollow: 1.0,  forgive: 0.85,   len: 1.5, width: 0.95, fat: 0.8, tube: 0.45, name: 'Hard' },     // steep, hollow, heavy
