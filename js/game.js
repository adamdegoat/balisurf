...
import { Wave, CONDITIONS, skyDome, ocean, setWeather, WeatherFX, ENV } from './wave.js?v=127';
...
import { SPOTS, spotGroup, builtSpots } from './spots.js?v=38';
import { villa, VILLA } from './villa.js?v=86';
