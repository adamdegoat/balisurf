...
import { Rider, Profile, waterAt, heightAt, RIDE, setBoard } from './surf.js?v=120';
...
import { crew } from './crew.js?v=10';
import { wildlife } from './wildlife.js?v=13';
...
const hairMeshes = [];   // your own hair: only drawn when you're seen from outside (for your own eyes it collapsed into a dark sheet)
